...
class VideoScriptProfile(AgentProfileBase):
    ...
    slide_mapping_requirements: list[str]
    scene_granularity_requirements: list[str]
    visual_direction_requirements: list[str]
    narration_requirements: list[str]
    subtitle_requirements: list[str]
    interaction_requirements: list[str]
    timing_and_pacing_requirements: list[str]
    production_feasibility_requirements: list[str]
